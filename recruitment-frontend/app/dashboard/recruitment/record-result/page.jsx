  ...
  return (
    <div>
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ color: "#6b7280", marginTop: "4px" }}>View all application results for a recruitment</p>
      </div>
      ...
      {!selectedRec ? (
        <div style={{ background: "white", borderRadius: "8px", padding: "60px", textAlign: "center", color: "#7f8c8d", border: "1px solid #ecf0f1" }}>
          <p style={{ fontSize: "15px", margin: 0 }}>Select a recruitment above to view its results.</p>
        </div>
      ) : (
        <>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px", marginBottom: "24px" }}>
            {[
              ...
              { label: "Hired", value: counts.hired, color: "#8b5cf6" },
          ...
          <div style={{ background: "white", borderRadius: "16px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", border: "1px solid #f3f4f6", overflow: "hidden" }}>
            {loading ? (
              ...
              <div style={{ padding: "40px", textAlign: "center", color: "#9ca3af" }}>No applications found.</div>
            ) : (
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead style={{ background: "linear-gradient(135deg, #f8fafc, #f1f5f9)" }}>
                  <tr>
                    {["#", "Candidate Name", "Email", "Applied At", "Status"].map(h => (
